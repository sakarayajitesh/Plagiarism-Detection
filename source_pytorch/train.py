...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='I',
                        help='hidden dimensations (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='I',
                        help='output dimensations (default: 1)')
